...
bool scan_pin_analog(pin_t pin, uint8_t row, uint8_t col) {
    ...
    uint16_t actuation_point = kb_config.global_actuation_settings.actuation_point_dmm * LOOKUP_TABLE_MULTIPLIER;
    ...
    if (kb_config.global_actuation_settings.rapid_trigger) {
        if (previous_states[row][col]) {
            ...
            int release_threshhold = current_extremes[row][col] - kb_config.global_actuation_settings.rapid_trigger_release_sensitivity_dmm * LOOKUP_TABLE_MULTIPLIER;
            ...
            uint16_t actuate_threshhold = current_extremes[row][col] + kb_config.global_actuation_settings.rapid_trigger_press_sensitivity_dmm * LOOKUP_TABLE_MULTIPLIER;
